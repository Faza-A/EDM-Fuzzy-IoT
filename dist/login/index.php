                    ...
                    <div class="container-fluid">
                        ...
                        <div class="card mb-4">
                            ...
                            <?php
                                ...
                                $sql1 = "SELECT * FROM (SELECT id, pga, tanggal, waktu from sensor1 ORDER BY id DESC LIMIT 10) Var1 ORDER BY id ASC";
                                $sql2 = "SELECT * FROM (SELECT id, pga, tanggal, waktu from sensor2 ORDER BY id DESC LIMIT 10) Var1 ORDER BY id ASC";
                                $sql3 = "SELECT * FROM (SELECT id, pga, tanggal, waktu from sensor3 ORDER BY id DESC LIMIT 10) Var1 ORDER BY id ASC";
                                ...
                                while ($row1 = mysqli_fetch_array($result1)) {
                                    $dataid1 = $dataid1 . '"'. $row1['id'].'",';
                                    $datapga1 = $datapga1 . '"'. $row1['pga'].'",';
                                }
                                while ($row2 = mysqli_fetch_array($result2)) {
                                    $dataid2 = $dataid2 . '"'. $row2['id'].'",';
                                    $datapga2 = $datapga2 . '"'. $row2['pga'].'",';
                                }
                                while ($row3 = mysqli_fetch_array($result3)) {
                                    $dataid3 = $dataid3 . '"'. $row3['id'].'",';
                                    $datapga3 = $datapga3 . '"'. $row3['pga'].'",';
                                }
                            ...
                            <div class="card-header"><i class="fas fa-chart-area mr-1"></i>Grafik sensor 1, 2 dan 3</div>
